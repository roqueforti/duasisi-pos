    ...
    <div className="p-3 sm:p-4 md:p-6 space-y-4 max-w-7xl mx-auto text-slate-800">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 bg-white p-4 sm:p-5 rounded-3xl border border-slate-200/80 shadow-2xs">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-2xl bg-[#1E4648] text-white flex items-center justify-center shadow-md">
        ...
        <button
          ...
          disabled={loading}
          className="px-3.5 py-2 bg-slate-100 hover:bg-slate-200 text-slate-700 font-bold rounded-xl text-xs flex items-center justify-center gap-1.5 transition self-start sm:self-auto"
        >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4">
        <div className="bg-white p-4 rounded-2xl border border-slate-200/80 shadow-2xs flex items-center gap-3.5">
          <div className="w-10 h-10 rounded-xl bg-teal-50 text-[#1E4648] flex items-center justify-center font-bold">
            <Users className="w-5 h-5" />
          </div>
          <div>
        ...
        <div className="p-4 border-b border-slate-100 flex flex-col md:flex-row gap-3 items-stretch md:items-center justify-between">
          <div className="relative flex-1 max-w-md">
            ...
            <input
              ...
              className="w-full pl-9 pr-3 py-2 bg-slate-50 border border-slate-200 rounded-xl text-xs font-semibold outline-none focus:border-[#1E4648]"
            />
          </div>
                  ...
                  <tr key={item.noHp} className="hover:bg-slate-50/80 transition">
                    ...
                    <td className="py-3.5 px-4 text-center">
                      <button
                        ...
                        className="px-2.5 py-1.5 bg-[#1E4648] hover:bg-[#153334] text-white rounded-xl font-bold text-[11px] transition inline-flex items-center gap-1 shadow-2xs"
                      >
          ...
          <div className="bg-white rounded-3xl p-5 sm:p-6 w-full max-w-2xl border border-slate-100 shadow-2xl my-auto max-h-[92vh] flex flex-col">
            ...
            <div className="flex items-center justify-between pb-3 border-b border-slate-100 shrink-0">
              <div className="flex items-center gap-2.5">
                <div className="w-9 h-9 rounded-xl bg-teal-50 text-[#1E4648] flex items-center justify-center font-bold">
                  <Users className="w-5 h-5" />
                </div>
                <div>
              ...
              <div className="bg-slate-50 border border-slate-200 rounded-2xl p-4 space-y-3">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2 bg-white border border-slate-300 rounded-xl font-semibold outline-none focus:border-[#1E4648]"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      placeholder="08..."
                      className="w-full px-3 py-2 bg-white border border-slate-300 rounded-xl font-mono font-bold outline-none focus:border-[#1E4648]"
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full p-2.5 bg-white border border-slate-300 rounded-xl font-medium outline-none focus:border-[#1E4648]"
                  />
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="max-h-56 overflow-y-auto space-y-2 pr-1">
                  {loadingHistory ? (
                    ...
                    historyList.map((tx) => (
                      <div key={tx.noNota} className="p-3 bg-white border border-slate-200 rounded-xl space-y-1 text-[11px]">
            ...
            <div className="flex gap-3 pt-3 border-t border-slate-100 shrink-0">
              ...
              <button
                ...
                disabled={savingEdit}
                className="flex-1 bg-[#1E4648] hover:bg-[#153334] text-white font-bold py-2.5 rounded-xl text-xs flex items-center justify-center gap-1.5 shadow-md transition"
              >
