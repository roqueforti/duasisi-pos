...
export const DEFAULT_LOYALTY_PROGRAMS: LoyaltyProgram[] = [
  {
    ...
    deskripsi: 'Khusus member lama: Klaim gratis langsung didapat pada stempel ke-10 saat transaksi.',
    kapasitas: '7kg',
  ...
  {
    id: 'CARD_EXPRESS_5STAMP',
    nama: 'Kartu Promo Cepat (5 Stamp, Diskon 50%)',
    deskripsi: 'Kumpulkan 5 stempel, dapatkan diskon 50% di transaksi berikutnya.',
    kapasitas: 'all',
    syaratLayanan: 'all',
    minTransaksi: 20000,
    totalStamps: 5,
    claimRule: 'FREE_ON_NEXT_TRX',
    rewardDeskripsi: 'Diskon 50% Cuci',
  ...
  {
    id: 'CARD_VIP_CASH_8STAMP',
    nama: 'Kartu VIP Hemat (8 Stamp, Potongan Rp 25.000)',
    deskripsi: 'Program 8 stempel: dapatkan potongan langsung Rp 25.000 setelah stempel penuh.',
    kapasitas: '7kg',
    syaratLayanan: 'washer_dryer',
    totalStamps: 8,
    claimRule: 'FLEXIBLE_VOUCHER',
    rewardDeskripsi: 'Potongan Rp 25.000',
