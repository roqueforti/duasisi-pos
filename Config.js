...
const ALLOWED_API_ACTIONS = Object.freeze({
  ...
  getPipelineSteps: true, updateDropoffStatus: true, updateStatus: true, getTransaksiList: true, getTransaksiByNota: true, getTransaksiByPipeline: true, importTransaksiBatch: true,
