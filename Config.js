...
const ALLOWED_API_ACTIONS = Object.freeze({
  ...
  simpanPelangganJikaBaru: true, cariPelangganByHp: true, getDaftarPelanggan: true, updateDataPelanggan: true, getRiwayatPelangganByHp: true, importPelangganBatch: true, daftarMember: true, tambahPelanggan: true, updateStempelPelanggan: true,
  getPipelineSteps: true, updateDropoffStatus: true, updateStatus: true, getTransaksiList: true, getTransaksiByNota: true, getTransaksiByPipeline: true, importTransaksiBatch: true, updateKasirTransaksi: true,
  getLaporanRange: true, getPegawaiList: true, tambahPegawai: true, updatePegawai: true, hapusPegawai: true, getRekapKinerjaPegawai: true,
  getPayrollSummary: true, savePayrollPayment: true,
...
const MANAGER_API_ACTIONS = Object.freeze({
  ...
  getPayrollSummary: true, savePayrollPayment: true, importTransaksiBatch: true,
  tambahMasterShift: true, hapusMasterShift: true,
  getLaporanRange: true, getAuditLogs: true, approveVoidTransaksi: true, getRekapKasShift: true, updateKasirTransaksi: true,
...
function getPriorityConfig() {
  ...
  return [
    { id: "p1", nama: "Reguler", durasiJam: 48, sla: 48, icon: "Clock", warna: "bg-teal-100 text-teal-800 border-teal-300", keterangan: "Pengerjaan standar 2 hari (48 Jam)", aktif: true },
    { id: "p2", nama: "Express", durasiJam: 24, sla: 24, icon: "Flame", warna: "bg-amber-100 text-amber-800 border-amber-300", keterangan: "Pengerjaan cepat 24 Jam", aktif: true },
    { id: "p3", nama: "Kilat", durasiJam: 6, sla: 6, icon: "Zap", warna: "bg-rose-100 text-rose-800 border-rose-300", keterangan: "Pengerjaan super kilat 6 Jam", aktif: true }
  ];
}
